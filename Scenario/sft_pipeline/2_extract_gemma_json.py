...
OUTPUT_FILE = "data/extracted_gemma.json"
PROGRESS_FILE = "data/progress_gemma.json"
...
def main():
    ...
    for chunk in tqdm(chunks, desc="Gemma 데이터 추출 중"):
        ...
        try:
            raw_response = extract_with_gemma(chunk['text'])
